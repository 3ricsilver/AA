...
pthread_t ThreadFenetreGraphique,ThreadEvenements,ThreadStanley,ThreadEnnemis,ThreadGuepes;
...
/*todo faire une fonction free pour libérer la mémoire*/
    ...
    pthread_create(&ThreadFenetreGraphique, NULL,fctThreadFenetreGraphique,NULL);//thread quand on start le jeu
    pthread_create(&ThreadEvenements, NULL,fctThreadEvenements,NULL);//thread pour lire le clavier
    ...
    while(1)
    {
        ...
        switch(EnnemiAleatoireRandomAuPif)
        {
            case 0://GUEPE
                break;
            case 1://CHENILLE_G
                pthread_create(&ThreadGuepes, NULL, fctThreadGuepe, NULL);
                break;
            case 2://CHENILLE_D
                break;
            case 3://ARAIGNEE_G
