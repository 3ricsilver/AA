...
/*
pourquoi je dois mettre :Image() que sur ces deux constructeurs et pas sur les autres ou le destructeur ou getter  setter
to do demander a pompito
*/
  ImageNG::ImageNG(const char* cheminFichierPhoto):Image(cheminFichierPhoto) 
  {
