...
void Essai1()
{
  ...
  // ...
  try//bout de code qui va créer une exception 
  {
    Couleur c;
  ...
  // recup grace au try
  catch(RGBException &exception) // récupération de l'erreur et la valeur
  {
    cout << "Erreur : " << exception.getMessage() << endl;
    cout << "Preuve : " << exception.getValeur() << endl;
  }
...
void Essai2()
{
  ...
  // ...
  catch(const XYException &exception) // récupération de l'erreur et la valeur
  {
    cout << "Erreur : " << exception.getMessage() << endl;
    cout << "Preuve : " << exception.getCoordonnee() << endl;
  }
...
void Essai3()
{
  ...
  {
    cout << "Erreur : " << XY.getMessage() << endl;
    cout << "Preuve : " << XY.getCoordonnee() << endl;
  }

  catch (RGBException &RGB) 
  {
     cout << "Erreur : " << RGB.getMessage() << endl;
     cout << "Preuve : " << RGB.getValeur() << endl;
  }
